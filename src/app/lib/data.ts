// this is no longer used, need to do prisma stuff
...
//     `;
//     return data.rows[0] as Campaign;
//   } catch (error) {
...
// export async function fetchCampaignByName(name: string) {
//   try {
//     const data = await sql<Campaign>`
//       SELECT * FROM campaign where name=${name}
//     `;
//     return data.rows[0] as Campaign;
//   } catch (error) {
//     console.error("Failed to fetch Campaign ", error);
...
// export async function fetchUserCampaigns(userId: string) {
//   try {
//     const data = await sql<Campaign>`
