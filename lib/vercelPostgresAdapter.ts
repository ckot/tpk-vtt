  ...
  try {
    ...
    const getUserByAccount = async ({
      ...
      const user = rows[0]
        ...
        : null;
      console.log("getUserByAccount() found:", user);
      return user;
    };
    ...
    const getSessionAndUser = async (
      ...
      console.log("getSessionAndUser() found:", sessionAndUser);
    ...
    const linkAccount = async (
      ...
      console.log("in linkAccount()", account);
      await sql`
    ...
    const createVerificationToken = async ({
      ...
      console.log("in createVerificationToken()", identifier, expires, token, "createdToken:", createdToken);
      return createdToken;
    };
    ...
    const useVerificationToken = async ({
      ...
      console.log("useVerifcationToken()", verificationToken);
